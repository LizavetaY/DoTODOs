...
import { setIsCloseCreateTodoModal } from '@/store/reducers/modalsSlice';
...
const CreateTodoModal = ({ onSubmit = () => {}, isLoading = false }) => {
  ...
  return (
    <>
      <Modal open={isOpenCreateTodoModal}>
        <Stack
          component="form"
          position="absolute"
          top="50%"
        ...
        >
          ...
          <Stack direction="row" justifyContent="flex-end" mt="40px">
            <Button
              variant="contained"
